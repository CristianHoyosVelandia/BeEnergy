...
class Metodos {
  ...
  alertsDialogBotonUnico(BuildContext context, String mensaje, double width,
      double height, String btn1, int accionbtn1) {
    return showDialog(
        context: context,
  ...
  alertsDialog(BuildContext context, String mensaje, double width, String btn1,
      int accionbtn1, String btn2, int accionbtn2) {
    return showDialog(
        context: context,
        builder: (context) => AlertDialog(
                shape: const RoundedRectangleBorder(
                ...
                content: Container(
                  ...
                  child: FittedBox(
                    fit: BoxFit.fitWidth,
                    child: Text(mensaje,
                        style: Metodos.alertDialogTextStyle(context,
                            Theme.of(context).focusColor, FontWeight.normal)),
                  ),
                ),
                actions: <Widget>[
                  SizedBox(
                        ...
                        children: [
                          Flexible(
                            ...
                            child: Container(
                              ...
                              child: TextButton(
                                  child: Text(btn1,
                                      style: Metodos.alertDialogTextStyle(
                                          context,
  ...
  static TextStyle appBartextStyle(BuildContext context,
    ...
    return TextStyle(
      color:
          (color != null) ? color : Theme.of(context).scaffoldBackgroundColor,
      fontSize: fontSize,
      fontWeight: fontWeight,
  ...
  Border borderCajas(context) {
    return Border.all(width: 1, color: Theme.of(context).focusColor);
  }
      ...
      actions: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
                width: 2.0, color: Theme.of(context).scaffoldBackgroundColor),
            borderRadius: BorderRadius.circular(25.0),
          ),
          margin: const EdgeInsets.only(
              top: 7.5, bottom: 7.5, right: 15.0, left: 0.0),
          child: IconButton(
              icon: const Icon(
                Icons.notifications,
                size: 25.0,
              ...
              onPressed: () async {
                alertsDialog(context, "¿Deseas cerrar tu sesión ahora?",
                    Metodos.width(context), "Cancelar", 2, "Si", 3);
              }),
        ),
      ],
    );
    ...
    return AppBar(
      ...
      title: Center(
        child: Text(
          ...
          textAlign: TextAlign.center,
          style: Metodos.textStyle(
              context, Metodos.colorInverso(context), 20, FontWeight.w600, 2.5),
        ),
      ),
      actions: [
        Container(
          ...
          margin: const EdgeInsets.only(
              top: 2.0, bottom: 2.0, right: 15.0, left: 0.0),
          child: IconButton(
              icon: const Icon(
  ...
  static TextStyle tittleTextStyle2(BuildContext context,
  ...
  static TextStyle btnTextStyleFondo(BuildContext context,
      [Color? color, FontWeight? fontWeight]) {
  ...
  static Border borderClasic(BuildContext context) {
    return Border.all(width: 0.25, color: Theme.of(context).focusColor);
  }

  static Border borderClasicFondoNegro(BuildContext context) {
    return Border.all(
        width: 0.25, color: Theme.of(context).scaffoldBackgroundColor);
  }

  static TextStyle alertDialogTextStyle(BuildContext context,
      [Color? color, FontWeight? fontWeight]) {
    return textStyle(context, color, 15, fontWeight, 1.5);
  }
  ...
  //Descripcion textos
  static TextStyle descripcionTextStyle(BuildContext context,
      [Color? color,
      double? fontSize,
      FontWeight? fontWeight,
      double? letterSpacing,
  ...
  static InputDecoration decorationformularios(
      BuildContext context, Color colApp1, String labelText) {
    return InputDecoration(
        contentPadding: const EdgeInsets.symmetric(horizontal: 0),
        alignLabelWithHint: true,
        fillColor: Colors.black,
        enabledBorder:
            UnderlineInputBorder(borderSide: BorderSide(color: colApp1)),
  ...
  static bool distancia(double latActual, double lonActual, double latDestino,
      double lonDestino, double distanciaMaxima) {
    ...
    var a = sin(v3 / 2) * sin(v3 / 2) +
        cos(v1) * cos(v2) * sin(v4 / 2) * sin(v4 / 2);
...
class InputTextFieldWidget extends StatelessWidget {
  InputTextFieldWidget({
    ...
    required String? Function(dynamic value) validador,
  });
  ...
  //Constantes
  static final List<TextInputFormatter> formatoSinTildes = [
    FilteringTextInputFormatter.deny(RegExp('[ñ,Á,é,É,í,Í,ó,Ó,ú,Ú,ü,Ü,Ñ,á]'))
  ];
  static final List<TextInputFormatter> formatoNombre = [
    FilteringTextInputFormatter.allow(RegExp('[a-zA-Z, ]'))
  ];
  static final List<TextInputFormatter> formatoSoloDigitos = [
    FilteringTextInputFormatter.digitsOnly
  ];
  static final List<TextInputFormatter> formatoTexto = [
    ...
    return Stack(
      children: <Widget>[
        Container(
          ...
          height: screenHeight,
          color:
              Theme.of(context).primaryColor.withAlpha((opacity * 255).toInt()),
          child: FittedBox(
            fit: BoxFit.none,
            alignment: const Alignment(0, 4),
            child: Container(
